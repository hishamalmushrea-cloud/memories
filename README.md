...
- جهاز بلا كاميرا، أو إذن مرفوض: رسالة واضحة، و«اختيار صورة» من معرض النظام
  يبقى متاحًا.
- تصوير الفيديو ليس ضمن هذه المرحلة: اختيار الفيديو ما زال من معرض النظام،
  والتسجيل الصوتي داخل التطبيق كما هو.

قواعد الكاميرا (أي عدسة، وأي حالة فلاش، وأي ثابت في CameraX يقابلها) في
`CameraControls` منفصلة عن CameraX لتُختبر بلا جهاز.
...
| `CameraControlsTest` | إعدادات الكاميرا: دورة الفلاش، والعدسة الأمامية بلا فلاش، ومطابقة كل إعداد لثابته في CameraX |
